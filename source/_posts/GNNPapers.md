---
title: "[Papers] GNNPapers"
catalog: true
toc_nav_num: true
date: 2019-09-29 14:09:01
subtitle: Some important papers on GNN
...
top: 1
---
> 来源于： https://github.com/thunlp/GNNPapers.git
...
<tr>
    <td>&emsp;<a href="#community-detection">3.17 Community Detection</a></td>
    <td></td>
</tr>
<tr><td colspan="2"><a href="#heterogeneous-graph">4. Heterogeneous Graph</a></td></tr>
<tr>
    <td>&emsp;<a href="#heterogeneous-graph-neural-network">4.1 Heterogeneous Graph Neural Network</a></td>
    <td>&ensp;<a href="#heterogeneous-graph-embedding">4.2 Heterogeneous Graph Embedding</a></td>
</tr>
<tr>
    <td>&emsp;<a href="#heterogeneous-graph-application">4.3 Heterogeneous Graph Application</a></td>
    <td></td>
</tr>
</table>
...
1. **Community Detection with Graph Neural Networks.** LCLR 2018. [paper](https://arxiv.org/pdf/1705.08415.pdf) [code](https://github.com/afansi/multiscalegnn)

    *Zhengdao Chen, Xiang Li, Joan Bruna.*

## [Heterogeneous Graph](#content)   
    
### [Heterogeneous Graph Neural Network](#content)

1.  **Metapath-guided Heterogeneous Graph Neural Network for Intent Recommendation.** KDD 2019. [paper](https://dl.acm.org/citation.cfm?id=3330673)

    *Shaohua Fan, Junxiong Zhu, Xiaotian Han, Chuan Shi, Linmei Hu, Biyu Ma, Yongliang Li.*

1.  **Heterogeneous Graph Neural Network.** KDD 2019

    *Chuxu Zhang, Dongjin Song, Chao Huang, Ananthram Swami, Nitesh V. Chawla.*

1.  **Fine-grained Event Categorization with Heterogeneous Graph Convolutional.** IJCAI 2019. [paper](https://arxiv.org/abs/1906.04580)
...
1.  **Deep Collective Classification in Heterogeneous Information Networks.** WWW 2018. [paper](https://dl.acm.org/citation.cfm?id=3186106)

    *Yizhou Zhang, Yun Xiong, Xiangnan Kong, Shanshan Li, Jinhong Mi, Yangyong Zhu.*

1.  **Heterogeneous Graph Neural Networks for Malicious Account Detection.** CIKM 2018.   [paper](https://dl.acm.org/citation.cfm?id=3272010)
...
### [Heterogeneous Graph Embedding](#content)
...
### [Heterogeneous Graph Application](#content)
